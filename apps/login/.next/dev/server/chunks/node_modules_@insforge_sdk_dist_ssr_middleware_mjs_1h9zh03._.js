module.exports = [
"[project]/node_modules/@insforge/sdk/dist/ssr/middleware.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// src/ssr/refresh.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$insforge$2f$shared$2d$schemas$2f$dist$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@insforge/shared-schemas/dist/index.js [middleware] (ecmascript) <locals>");
...
async function refreshAuth(options = {}) {
    ...
    if (!refreshToken) {
        ...
        const error2 = new InsForgeError("Refresh token cookie is missing", 401, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$insforge$2f$shared$2d$schemas$2f$dist$2f$error$2d$codes$2e$schema$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["ERROR_CODES"].AUTH_UNAUTHORIZED);
        return {
    ...
    try {
        ...
        if (!response.ok) {
            error = normalizeError(body ?? {
                ...
                error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$insforge$2f$shared$2d$schemas$2f$dist$2f$error$2d$codes$2e$schema$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["ERROR_CODES"].UNKNOWN_ERROR
            });
        } else {
            data = body;
        }
...
//# sourceMappingURL=node_modules_%40insforge_sdk_dist_ssr_middleware_mjs_1h9zh03._.js.map